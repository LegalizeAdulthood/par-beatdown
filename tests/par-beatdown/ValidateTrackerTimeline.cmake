...
if(DEFINED PAR_BEATDOWN_START)
    list(APPEND command_arguments --start "${PAR_BEATDOWN_START}")
endif()
if(DEFINED PAR_BEATDOWN_DURATION)
    list(APPEND command_arguments --duration "${PAR_BEATDOWN_DURATION}")
endif()
...
if(DEFINED PAR_BEATDOWN_START)
    assert_json_number_equal("render.start_seconds" "${PAR_BEATDOWN_START}"
        render start_seconds)
endif()
if(DEFINED PAR_BEATDOWN_DURATION)
    assert_json_number_equal("render.duration_seconds"
        "${PAR_BEATDOWN_DURATION}" render duration_seconds)
endif()
...
if(has_timeline)
    ...
    if(DEFINED PAR_BEATDOWN_START AND DEFINED PAR_BEATDOWN_DURATION)
        assert_json_number_equal("timeline.duration_seconds"
            "${PAR_BEATDOWN_DURATION}" timeline duration_seconds)
    else()
...
if(has_features)
    ...
    if(DEFINED PAR_BEATDOWN_START)
        assert_json_number_equal("features[0].time_seconds" 0
            features 0 time_seconds)
        assert_json_number_equal("features[0].frame" 0 features 0 frame)
    endif()
